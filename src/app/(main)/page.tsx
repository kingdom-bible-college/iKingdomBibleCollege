    ...
    <main className={styles.main}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <Link href="/about?menu=introduction" className={styles.heroBtn}>
            KBC 소개
          </Link>
        </div>
      </section>
      ...
      <section className={styles.about}>
        ...
        <div className={styles.aboutContent}>
          <p>
            KINGDOM BIBLE COLLEGE는 <strong>성경, 상담, 영성, 선교</strong>
            <br />
            4개의 단과대학으로 구성되어 있으며 24개 과목을 18주 동안 집중
            강의합니다.
          </p>
          <p>
            국내 사역 현장 그리고 해외 단기 선교 실습으로 구성된 새로운 시대의
            영성과
            <br />
      ...
      <section className={styles.colleges}>
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("https://images.unsplash.com/photo-1504052434569-70ad5836ab65?w=400")',
          }}
        >
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400")',
          }}
        >
          <div className={styles.collegeInfo}>
            <h3>
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("https://images.unsplash.com/photo-1507692049790-de58290a4334?w=400")',
          }}
        >
          <div className={styles.collegeInfo}>
            <h3>
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?w=400")',
          }}
        >
          <div className={styles.collegeInfo}>
            <h3>
        ...
        <div className={styles.testimonialGrid}>
          <div className={styles.testimonialCard}>
            <p className={styles.testimonialText}>
              "KBC를 통해 성경을 체계적으로 배울 수 있었습니다. 단순한 지식이
              아닌, 삶을 변화시키는 말씀의 능력을 경험했습니다."
            </p>
          ...
          <div className={styles.testimonialCard}>
            <p className={styles.testimonialText}>
              "상담대학 과정을 통해 사람들의 아픔에 더 깊이 다가갈 수 있게
              되었습니다. 현장 실습이 특히 도움이 되었습니다."
            </p>
            <div className={styles.testimonialAuthor}>
          ...
          <div className={styles.testimonialCard}>
            <p className={styles.testimonialText}>
              "해외 단기 선교 실습을 통해 선교의 열정을 다시 불태울 수
              있었습니다. 실제적인 사역 훈련이 큰 도움이 됩니다."
            </p>
            <div className={styles.testimonialAuthor}>
