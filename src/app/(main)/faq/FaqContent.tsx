    ...
    items: [
      {
        ...
        answer:
          '홈페이지 우측 상단 \'로그인\' 버튼을 클릭하고, 이후 나오는 회원가입 버튼을 클릭하여 이름, 이메일, 비밀번호를 입력하면 가입됩니다.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          '국민은행 461301-04-610726 (예금주: 킹덤바이블칼리지) 계좌로 입금해주세요. 입금 후 연락 부탁드립니다.',
      },
      {
        question: '환불이 가능한가요?',
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        question: '강사진은 누구인가요?',
        answer:
          "황성은 목사, 김태헌 목사 등이 출강하며, 온라인 강사진도 함께합니다. 자세한 내용은 'KBC 소개' 페이지에서 확인하세요.",
      },
      {
        question: '학점 인정이 되나요?',
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          '대표전화 042-824-3242 또는 사무처장 도현우 (010-3542-3703), 간사 전미래 (010-8966-0558)로 연락해주세요.',
      },
      {
